...
/***/ function(module, exports, __webpack_require__) {
	...
	var PokemonIndex = __webpack_require__(166);
	// window.ApiUtil = require('./utils/api_util');

	document.addEventListener("DOMContentLoaded", function () {
	  ReactDOM.render(React.createElement(PokemonIndex, null), document.getElementById('root'));
	});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ApiUtil = {
	  ...
	  fetchSinglePokemon: function fetchSinglePokemon(id, cb) {
	    $.ajax({
	      url: 'api/pokemon/' + id,
	      success: cb
	    });
	  },
	  fetchAllPokemons: function fetchAllPokemons(cb) {
	    $.ajax({
	      url: "api/pokemon",
	      success: cb
...
/***/ function(module, exports, __webpack_require__) {
	...
	var PokemonActions = {
	  ...
	  receiveAllPokemons: function receiveAllPokemons(pokemons) {
	    Dispatcher.dispatch({
	  ...
	  receiveSinglePokemon: function receiveSinglePokemon(pokemon) {
	    Dispatcher.dispatch({
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var PokemonStore = __webpack_require__(167);
	var PokemonActions = __webpack_require__(160);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var resetPokemon = function resetPokemon(pokemon) {
	  _pokemons[pokemon.id] = pokemon;
	};

	var resetPokemons = function resetPokemons(pokemons) {
